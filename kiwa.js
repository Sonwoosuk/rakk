(function () {
  ...
  /* =========================================================
     기와 객실 섹션 스크롤 스파이 & Fixed 엘리먼트 제어
  ========================================================= */
  const roomsSection = document.getElementById("kiwaRoomsSection");
  ...
  const hanjaGae = document.querySelector(".char-gae");
  const hanjaWa = document.querySelector(".char-wa");
        ...
        if (entry.isIntersecting) {
          if (roomsSideNav) {
            ...
            if (!wasVisible) {
              ...
              if(hanjaGae) hanjaGae.classList.add("is-active");
              if(hanjaWa) hanjaWa.classList.add("is-active");
            }
          }
          if (roomsBookBtn) {
